...
if(isset($_POST['update'])){
    ...
    $query2 = "UPDATE `standard` SET `id`='$id',`std_name`='$std_name' WHERE `id` = $id";
...
<head>
    ...
    <title>Standard Edit Page</title>
    <style>
        body{
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                <td>Standard</td>
                <td><input class="inputfield" type="text" name="std_name" value="<?php echo $std_name; ?>"></td>
            </tr>   
        </table>
        <br>
        <span>
